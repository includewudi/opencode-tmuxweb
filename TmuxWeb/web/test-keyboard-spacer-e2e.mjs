...
async function testKeyboardSpacerDesktop() {
  ...
  // Take screenshot
  await page.screenshot({ path: `${EVIDENCE_DIR}/keyboard-spacer-desktop-noop.png` });
...
async function testKeyboardSpacerMobileOpen() {
  ...
  // Take screenshot
  await page.screenshot({ path: `${EVIDENCE_DIR}/keyboard-spacer-open.png` });
...
async function testKeyboardSpacerMobileClose() {
  ...
  // Take screenshot
  await page.screenshot({ path: `${EVIDENCE_DIR}/keyboard-spacer-close.png` });
...
async function testKeyboardSpacerOrientation() {
  ...
  fs.writeFileSync(
    `${EVIDENCE_DIR}/keyboard-spacer-orientation.json`,
...
async function runAllTests() {
  try {
    ...
    fs.writeFileSync(
      `${EVIDENCE_DIR}/keyboard-spacer-test-summary.json`,
