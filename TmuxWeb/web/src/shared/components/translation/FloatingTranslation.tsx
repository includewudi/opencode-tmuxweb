...
import { Languages, Minus, X, Maximize2, Minimize2 } from 'lucide-react'
import { useFloatingPanel } from '../imperial-study/hooks/useFloatingPanel'
import { TranslationPanel } from './TranslationPanel'
import '../file-browser/file-browser.css'
import './TranslationPanel.css'

interface FloatingTranslationProps {
  paneId?: string | null
  onClose: () => void
}

export function FloatingTranslation({ paneId, onClose }: FloatingTranslationProps) {
  ...
  const {
    ...
    storageKey: 'translation-floating',
  ...
  return (
    ...
    >
      <div className="fb-floating-panel__titlebar" onMouseDown={onDragStart}>
        <Languages size={12} className="fb-floating-panel__icon" />
        <span className="fb-floating-panel__title">翻译 Translation</span>
        <span className="fb-floating-panel__stats">
          {paneId || 'No active pane'}
        </span>
      ...
      <div className="fb-floating-panel__body">
        <TranslationPanel paneId={paneId} />
      </div>
